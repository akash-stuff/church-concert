    ...
    <tr><td align="center">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#ffffff;border:1px solid ${LINE};border-radius:12px;overflow:hidden;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;">
        <tr><td style="background:${NAVY};padding:24px 32px;">
          ...
          <span style="display:block;color:${GOLD};font-size:11px;letter-spacing:0.12em;text-transform:uppercase;margin-top:2px;">Seat register</span>
        </td></tr>
...
const codeBlock = (code) =>
  `<table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 20px;"><tr><td style="background:#fdf7ea;border:1px solid #ecd9ac;border-radius:10px;padding:18px 28px;text-align:center;">
...
const button = (href, label) =>
  `<table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 20px;"><tr><td style="background:${GOLD};border-radius:999px;">
     <a href="${esc(href)}" style="display:inline-block;padding:13px 28px;font-size:15px;font-weight:700;color:#1c1508;text-decoration:none;">${esc(label)}</a>
   </td></tr></table>`;
